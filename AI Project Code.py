...
class Data:
    ...
    def __init__(self):
        ...
        course2=Course("C2","319K",[self._instructors[0],self._instructors[1]],35)
...
class Course:
    ...
    def get_instructors(self):return self._instructors 
    def get_maxNumberOfStudents(self):return self._maxNumberOfStudents 
...
class DisplayMgr:
    ...
    def print_generation(self,population):
            table1=prettytable.PrettyTable(['schedule #','fitness','# No of conflicts','classes[dept,class,room,instructor]'])
    ...
    def print_schedule_as_table(self,schedule):
            ...
            table=prettytable.PrettyTable(['class #','Dept','Course(number,max # of student)','Room(capacity)','Instructor'])
            for i in range(0,len(classes)):
